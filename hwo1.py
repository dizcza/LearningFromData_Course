...
def generatePoints(numberOfPoints):
    ...
    for i in range(0, numberOfPoints - 1):
        ...
        points.append(
            [1, x, y, targetFunction(x1, y1, x2, y2, x, y)])  # add 1/-1 indicator to the end of each point list
...
def runSimulation(numberOfTrials, numberOfTestPoints, iterationLimit):
    ...
    print
    "Avg. iterations: " + str(np.mean(interations)) + " : Avg. error probability: " + str(np.mean(probability))
